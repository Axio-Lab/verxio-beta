...
import { getLoyaltyProgramDetails, getCollectionAuthoritySecretKey, getLoyaltyProgramUsers } from '@/app/actions/loyalty';
    ...
    const fetchProgramDetails = async () => {
      ...
      try {
        ...
        if (details.success && details.programDetails) {
          setProgramDetails(details.programDetails);
        }
      } catch (error) {
                        ...
                        <div className="bg-white/10 rounded p-2">
                          <div className="flex items-center justify-between">
                            ...
                            <span className={`px-2 py-1 rounded text-xs font-medium ${
                              currentTier === 'Gold' ? 'bg-gradient-to-r from-amber-500/20 to-yellow-600/20 text-amber-300 border border-amber-400/30' :
